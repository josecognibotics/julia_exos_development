...
julia_exos_buffer_info,fexos_
julia_exos_dataset_private,
julia_exos_dataset_handle

#----------------- Shared library path -----------------
const libexos_api = "/usr/lib/libexos-api.so"
const libexos_app = "/home/user/exOS-ComponentExtension/JULIA_PK4/stringandarray/src/lib_exosstringarray.so"
