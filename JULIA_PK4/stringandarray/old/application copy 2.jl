...
println("Pointer cb1: ", datamodel_event_cb)
...
println("Pointer cb2: ", config_change_cb)
...
const StringAndArray_0_C            = Base.unsafe_convert(Cstring, "StringAndArray_0")::Cstring
const gStringAndArray_0_C           = Base.unsafe_convert(Cstring, "gStringAndArray_0")::Cstring
...
function julia_datamodel_connect_stringarray(datamodel::Ptr{julia_exos_datamodel_handle}, datamodel_event_cb::Ptr{Cvoid})
        println("HELLO")
        println("StringAndArray ptr: $datamodel")
        println("Callback ptr: $datamodel_event_cb")
        #println("StringAndArray ptr: $datamodel_event_cb")
    #=
    ...
    =#  
        GC.@preserve datasets_size
        GC.@preserve datasets
...
function main()
    ...
    GC.@preserve stringandarray_handle ptr_stringandarray_handle datamodelEvent exos_config_change_cb begin
    ...
    =#
        ...
        * The datamodel handle is then used for receiving incoming messages using the `exos_datamodel_process()`
        ...
        datamodel_init = @ccall libexos_api.exos_datamodel_init(ptr_stringandarray_handle::Ref{julia_exos_datamodel_handle}, Ref{Cstring}(StringAndArray_0_C)::Ref{Cstring}, Ref{Cstring}(gStringAndArray_0_C)::Ref{Cstring})::Cint
        ...
        println("datamodel_init\t\t\t-> ERROR_CODE: $datamodel_init")
        ...
        * This function initializes the `exos_dataset_handle_t` structure, meaning it zeroes all members and sets artefact, data and size members.
        =#
        dataset_init1 = @ccall libexos_api.exos_dataset_init(myint1::Ref{julia_exos_dataset_handle}, ptr_stringandarray_handle::Ref{julia_exos_datamodel_handle}, Ref{Cstring}(MyInt1_Cstring)::Ref{Cstring}, ptr_MyInt1::Ptr{Cvoid}, sizeof(data[].MyInt1)::Csize_t)::Cint
        ...
        * If the dataset is connected, it will be disconnected before being deleted.
        ...
        dataset_init2 = @ccall libexos_api.exos_dataset_init(myint2::Ref{julia_exos_dataset_handle}, ptr_stringandarray_handle::Ref{julia_exos_datamodel_handle}, Ref{Cstring}(MyInt2_Cstring)::Ref{Cstring}, ptr_MyInt2::Ptr{Cvoid}, sizeof(data[].MyInt2)::Csize_t)::Cint
        ...
        GC.@preserve stringandarray_handle datamodel_event_cb julia_datamodel_connect_stringarray(ptr_stringandarray_handle, datamodel_event_cb)
    end
return 0
end
main()                                                      
