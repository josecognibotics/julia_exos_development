...
function julia_datamodel_connect_stringarray(datamodel::Ptr{julia_exos_datamodel_handle}, datamodel_event_cb::Ptr{Cvoid})
        ...
        * The function is "internal" meaning it shouldnt be used in an application unless there are specific reasons to do so. Applications should refer to the automatically generated headerfile.
        =#
        datamodel_connect = @ccall libexos_api.exos_datamodel_connect(datamodel::Ptr{julia_exos_datamodel_handle}, Ref{Cstring}(StringAndArray_0_C)::Ref{Cstring}, Ref{Cstring}(gStringAndArray_0_C)::Ref{Cstring})::Cint
