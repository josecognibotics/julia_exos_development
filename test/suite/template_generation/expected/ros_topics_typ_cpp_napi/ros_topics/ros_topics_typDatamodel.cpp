...
void ros_topics_typDatamodel::connect() {
    ...
    odemetry.connect((EXOS_DATASET_TYPE)EXOS_DATASET_PUBLISH);
    twist.connect((EXOS_DATASET_TYPE)EXOS_DATASET_SUBSCRIBE);
    config.connect((EXOS_DATASET_TYPE)EXOS_DATASET_SUBSCRIBE);
}
