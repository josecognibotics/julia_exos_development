...
TYPE
	...
	ros_topic_twist_typ : 	STRUCT  (*This expresses velocity in free space broken into its linear and angular parts.*)
		angular : ros_topic_vector3_typ; (*SUB*)
		linear : ros_topic_vector3_typ; (*SUB*)
	END_STRUCT;
...
The orientation parameters use a fixed-axis representation. In order, the parameters are:
 (x, y, z, rotation about X axis, rotation about Y axis, rotation about Z axis)*)
	...
	ros_topic_odemety_typ : 	STRUCT 
		pose : ros_topic_poseCor_typ; (*PUB*)
		twist : ros_topic_twistCor_typ; (*PUB*)
		header : ros_topic_header_typ; (*PUB*)
	END_STRUCT;
	ros_config_typ : 	STRUCT 
		maxSpeed : LREAL := 2; (*SUB*)
		minSpeed : LREAL := -2; (*SUB*)
		baseWidth : LREAL := 0.53; (*SUB*)
	END_STRUCT;
