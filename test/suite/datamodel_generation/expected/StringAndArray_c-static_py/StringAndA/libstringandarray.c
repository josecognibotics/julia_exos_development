...
static void libStringAndArray_connect(void)
{
    ...
    //connect datasets
    EXOS_ASSERT_OK(exos_dataset_connect(&(h_StringAndArray.myint1), EXOS_DATASET_PUBLISH, libStringAndArray_datasetEvent));
    EXOS_ASSERT_OK(exos_dataset_connect(&(h_StringAndArray.mystring), EXOS_DATASET_PUBLISH, libStringAndArray_datasetEvent));
...
libStringAndArray_t *libStringAndArray_init(void)
{
    ...
    h_StringAndArray.ext_stringandarray.MyInt1.publish = libStringAndArray_publish_myint1;
    h_StringAndArray.ext_stringandarray.MyString.publish = libStringAndArray_publish_mystring;
