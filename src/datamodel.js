...
class Datamodel {
    ...
    /**
     * @returns {string} preset name of the headerfile (this file is not automatically generated by the `Datamodel`, but the contents can be accessed via the `headerFileCode` property)
     */
    get headerFileName() {
    ...
    /**
     * @returns {string} preset name of the source code file (this file is not automatically generated by the `Datamodel`, but the contents can be accessed via the `sourceFileCode` property)
     */
    get sourceFileName() {
