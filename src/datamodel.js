...
class Datamodel {
    ...
    /**
     * @returns {string} default name of the headerfile (this file is not automatically generated by the `Datamodel`, but the contents can be accesses via `headerFileCode()`)
     */
    get headerFileName() {
    ...
    /**
     * @returns {string} default name of the source code file (this file is not automatically generated by the `Datamodel`, but the contents can be accesses via `sourceFileCode()`)
     */
    get sourceFileName() {
