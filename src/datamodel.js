...
class Datamodel {
    ...
    /**
     * ASCII string with C-datatype definitions of the datatype {@link typeName} - this is part of the {@link headerFileCode}
     * 
   ...
   /**
    ...
    /**
     * the generated source code of the datamodel headerfile as ASCII string. 
     * 
    ...
    /**
     * preset name of the headerfile (this file is not automatically generated by the {@link Datamodel}, but the contents can be accessed via the {@link headerFileCode} property)
     * 
     * @type {string}
     */
    headerFileName;
    ...
    /**
     * the source code for the datamodel connection as ASCII string. 
     * 
     * *PREVIOUSLY:* `generateHeader`
     * 
     * @type {string} 
    ...
    /**
     * preset name of the source code file (this file is not automatically generated by the {@link Datamodel}, but the contents can be accessed via the {@link sourceFileCode} property)
     * 
     * @type {string} 
     */
    sourceFileName;
    ...
    constructor(fileName, typeName, SG4Includes) {
        ...
        this.sourceFileCode = this._makeSource();
        this.dataTypeCode = this._makeDataTypes();
        this.dataTypeCodeSWIG = this._makeDataTypes(true);
        this.headerFileCode = this._makeHeader();
        this.headerFileName = `exos_${this.typeName.toLowerCase()}.h`;
        this.sourceFileName = `exos_${this.typeName.toLowerCase()}.c`;
    }
