...
{
    napi_value stringandarray_conn_change, stringandarray_onprocessed, MyInt1_conn_change, MyString_conn_change, MyInt2_conn_change, MyIntStruct_conn_change, MyIntStruct1_conn_change, MyIntStruct2_conn_change;
    napi_value MyInt1_onchange, MyString_onchange, MyInt2_onchange, MyIntStruct_onchange, MyIntStruct1_onchange, MyIntStruct2_onchange;
    napi_value MyInt2_publish, MyIntStruct_publish, MyIntStruct1_publish, MyIntStruct2_publish;
    napi_value MyInt1_value, MyString_value, MyInt2_value, MyIntStruct_value, MyIntStruct1_value, MyIntStruct2_value;
